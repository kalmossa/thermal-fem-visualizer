...
def copyto(fname, *dest_parts):
    """Place un CSV dans une arborescence de classement.

    Chaque fichier apparaît dans les 4 classements : dupliquer réellement les
    180 CSV ferait passer le dossier de 27 Mo à plus de 100 Mo, pour un contenu
    strictement identique. On crée donc un lien physique — une seule copie sur
    le disque, visible depuis les quatre arborescences — avec repli sur une
    copie si le système de fichiers ne les gère pas.
    """
